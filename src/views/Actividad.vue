    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-secundario
          h2 Herramientas de control en una campaña publicitaria
        p.mb-4 El objetivo de la actividad es que el aprendiz afiance los conocimientos acerca de el pretest y el postest  de las campañas publicitarias.
