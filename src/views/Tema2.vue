  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center
      .col-lg-3.col-md-6.col-9.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/temas/t2/imag1.svg', alt='')
    ...
    .row.mb-4(data-aos="fade-down")
      ...
      .col-lg-3.col-md-6.b-left.mb-4
        .row.justify-content-center.mb-4
          .col-lg-5.col-md-6.col-5
            img(src='@/assets/curso/temas/t2/imag4.svg', alt='')
        p.text-center #[b Analizar el impacto de las campañas.]
      .col-lg-3.col-md-6.b-left.mb-4
        .row.justify-content-center.mb-4
          .col-lg-5.col-md-6.col-5
            img(src='@/assets/curso/temas/t2/imag5.svg', alt='')
        p.text-center #[b Realizar inteligencia de negocios.]

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6(data-aos="fade-right")
        h4.tit-tercer.mb-4 #[span ¿Qué implica] la implementación del ROI?
    ...
    p.mb-4(data-aos="fade") En la siguiente tabla se presentan esta clase de indicadores relacionados con su tipo y variables.

    .titulo-sexto.color-secundario(data-aos="fade-right")
      h5 Tabla 1.
      span Indicadores KPI
    
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-lg-8
        .tabla-a.color-secundario
          table(alt='La tabla consta de tres columnas, donde se presentan las variables mercadeo y comercialización, diferentes tipos de cada variable, y los indicadores de cada tipo.')
            thead
              tr
                th Variable
                th Tipo
            ...
            tbody
              tr
                ...
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    ...
                    li 
                      i.fas.fa-play
                      | Pertenencia al segmento de mercado.
              tr
                td.text-center Educación
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    li 
                      i.fas.fa-play
              ...
              tr
                td.text-center Interacciones externas
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    li 
                      i.fas.fa-play
                    ...
                    li 
                      ...
                      | Eventos.
              tr
                td.text-center Interacciones en punto de venta
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    li 
                      i.fas.fa-play
                    ...
                    li 
                      i.fas.fa-play
                      | Muestreo / degustación.
              tr
                td.text-center Interacciones #[em online]
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    li 
                      i.fas.fa-play
              ...
              tr
                td.text-center Interacciones #[em offline]
                td 
                  ul.lista-ul--color.fa-ul.color-acento-contenido
                    li 
                      i.fas.fa-play
    ...
    h4.tit-tercer.mb-4(data-aos="fade-right") #[span Variable] mercadeo:
    p.mb-4 esta variable en el desarrollo de los indicadores clave se refiere a los puntos de contacto con los clientes reales, clientes potenciales y consumidores; en esta se pueden desarrollar los siguientes tipos de indicadores:
    ...
    p.mb-4 es una variable importante para la evaluación del rendimiento de la empresa para determinar sus resultados. Se desarrollan estos tipos de indicadores:
    ...
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-lg-4.col-md-6.mb-3.mb-lg-0
        .tarjeta.color-acento-contenido.p-5.h-100
          ...
          h4.text-white Costos
          p.text-white Incluye todo tipo de costos, desde el que tiene el obtener nuevos clientes hasta los programas de quejas y reclamos de los mismos que implica la devolución y pérdida de productos.
      .col-lg-4.col-md-6.mb-3.mb-lg-0
        .tarjeta.color-acento-contenido.p-5.h-100
          .row.mb-4
            .col-4.col-md-5.col-lg-4
      ...
      .col-lg-4.col-md-6.mb-3.mb-lg-0
        .tarjeta.color-acento-contenido.p-5.h-100
          ...
          h4.text-white Retornos
          p.text-white Es la razón de ser del ROI, no hay negocio si no hay retorno; es decir, si no existe una diferencia significativa entre costos e ingresos.

    h4.tit-tercer.mb-4(data-aos="fade-right") #[span Relacionamiento] de los indicadores KPI
    p.mb-4 Cada indicador debe tener un valor atribuido para que se pueda medir. En la siguiente tabla, se puede determinar lo que con cada tipo de indicador se consigue evaluar dentro de la empresa. 
   
    .row.justify-content-center.align-items-center(data-aos="fade-down")
      .col-lg-10
        .titulo-sexto.color-secundario
          h5 Tabla 2. 
          span Indicador y evaluación
        .tabla-a.color-secundario
          table(alt='La tabla presenta diferentes tipos de indicadores, su correspondiente ejemplo y dos preguntas para cada tipo de indicador: una sobre evaluación monetaria, y la otra sobre evaluación de influencia.')
            thead
              tr
            ...
            tbody
              tr
                td.fw-bold.text-center Posicionamiento
              ...
              tr
                td.fw-bold.text-center Educación
              ...
              tr
                td.fw-bold.text-center Interacción
                td Prueba de muestra gratis
                td ¿Cuántas personas probaron la muestra gratis del producto?
                td ¿Qué niveles de influencia tuvo la muestra gratis con la decisión de compra?
              tr
                td.fw-bold.text-center Costos
                td Costo de muestras gratis + actividades de educación e interacción.
                td ¿Cuánto costó la campaña?
                td ¿Cuál fue la inversión total del proyecto?
              tr
                td.fw-bold.text-center Ingresos
                td Precio de venta
