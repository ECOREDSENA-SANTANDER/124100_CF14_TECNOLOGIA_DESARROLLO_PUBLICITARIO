...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-end.justify-content-center.mb-5
      .col-lg-3.col-md-9.mb-4(data-aos="fade-right")
    ...
    .row.justify-content
      .col-lg-1 
        img.mb-4(src='@/assets/curso/temas/t1/imag2.svg', alt='')
        img(src='@/assets/curso/temas/t1/imag3.svg', alt='')
      .col-lg-8
        p.mb-4 En cuanto #[b al mensaje, este se puede evaluar antes y después del lanzamiento de la campaña;] y un estudio previo a la campaña permite seleccionar el más adecuado, realizar todos los cambios pertinentes y evitar que sea incomprensible, erróneo o ambiguo. Mientras que el análisis posterior permite medir el nivel de comprensión real que el mercado tuvo del mensaje y la realización de correcciones para publicaciones futuras.
        ...
        SlyderF.mb-5(columnas="col-lg-6 col-xl-6")
          .tarjeta.bg1.p-4
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/temas/t1/slyder1.svg' alt='AvatarTop')
          ...
          .tarjeta.bg1.p-4
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/temas/t1/slyder9.svg' alt='AvatarTop')
    ...
    .row
      .col-lg-4
        ...
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.color-acento-contenido
            .p-4
              p Determinar el nivel de impacto que tiene el mensaje sobre el público objetivo.
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/t1/tarjeta3.svg' alt='AvatarTop')
          .tarjeta.color-acento-contenido
            .p-4
              p Medir el grado de recordación del mensaje.
      
      .col-lg-4
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/t1/tarjeta4.svg' alt='AvatarTop')
          .tarjeta.color-acento-contenido
            .p-4
              p Definir el grado de comprensión que tiene el mercado acerca del mensaje que se busca transmitir.
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/t1/tarjeta5.svg' alt='AvatarTop')
          .tarjeta.color-acento-contenido
            .p-4
              p Definir si el mensaje está en contra de la ética y moral de la audiencia.
      
      .col-lg-4
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/t1/tarjeta6.svg' alt='AvatarTop')
          .tarjeta.color-acento-contenido
            .p-4
              p Determinar el grado de credibilidad del mensaje publicitario.
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img
            img(src='@/assets/curso/temas/t1/tarjeta7.svg' alt='AvatarTop')
          .tarjeta.color-acento-contenido
            .p-4
              p Conocer el grado de asociación del mensaje con el producto o servicio.
    
    h4 Momento para la realización del pretest

    p.mb-4 Es importante recordar que el pretest se hace durante el proceso de elaboración de la campaña publicitaria y, mientras se realiza la campaña, el mensaje debe ser sometido a un minucioso sistema de creación; es por eso que el pretest puede estar presente en diferentes fases :
    ...
    .row
      .col-lg-8
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
            ...
            .row(titulo="Primeras reacciones")
    ...
    TabsC.color-secundario.mb-4
      ...
      .py-3.py-md-4(titulo="Eye Tracking")
        .row.justify-content-center.align-items-center.mb-5
          .col-md-5.mb-4.mb-md-0
            p #[b Eye Tracking:] es una herramienta más asequible para la mayoría de empresas. Permite medir y monitorizar el movimiento de los ojos; y define:        
            ul.lista-ul--color
              li 
                i.lista-ul__vineta
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        h4  B Cualitativos: 
        p.mb-4 para el desarrollo de este tipo de test se utilizan métodos cualitativos de investigación: sesiones de grupo, técnicas proyectivas para conocer los sentimientos de los individuos hacia los anuncios publicitarios, entre otros. Este tipo de test se utilizan en las primeras etapas del proceso creativo.
      .col-lg-2
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-9
        h4 Pretest individual
        p.mb-4 Se ejecuta cuando la empresa ha realizado un único anuncio publicitario para publicar en los diferentes medios de comunicación, en este caso los esfuerzos de la investigación se enfocan en conocer la comprensión del mensaje y los posibles ajustes que se deben realizar a la pieza para lograr la mayor efectividad posible.
        h4 Pretest múltiple
    ...
    h4 Postest
    p.mb-4 El postest es un proceso de investigación que se realiza durante el proceso de ejecución de la campaña publicitaria; este permite medir los efectos que ha tenido o tuvo la campaña y el logro de los objetivos de la misma.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        h4  B Audiencia alcanzada: 
        p.mb-4 los niveles de ventas, leads  y otros indicadores de respuesta del mercado objetivo son mediciones que permiten determinar la efectividad de la campaña.
      .col-lg-1
        img(src='@/assets/curso/temas/t1/imag16.svg', alt='')
    
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        h4  C Modificación de actitudes e imagen: 
        p.mb-4 de acuerdo con los objetivos de comunicación que también incluyen aspectos cualitativos, es necesario medir los cambios en las actitudes del mercado objetivo y los cambios en la imagen que el producto o servicio, basado con la percepción del target. 
      .col-lg-1
        img(src='@/assets/curso/temas/t1/imag17.svg', alt='')
    
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8
        h4  D Comportamiento de compra:
        p.mb-4 toda acción de marketing , inclusive las campañas publicitarias, tienen como finalidad el incremento en las ventas o un cambio de actitud frente a ellas, este es un elemento a medir en el postest y representa un alto nivel de importancia para determinar si se está cumpliendo con los indicadores. Sin embargo, se puede dar el caso en que una campaña tiene como finalidad el cambio en el consumo de un producto o las razones para hacerlo; por ejemplo, que un detergente no se use únicamente para lavar la ropa, sino que se utilice como multiusos
      .col-lg-1
